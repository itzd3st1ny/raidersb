...
ctypes.windll.kernel32.SetConsoleTitleW(f'Raid | Loading...')
# ----------------- imports ----------------- #
...
time.sleep(0.50)
ctypes.windll.kernel32.SetConsoleTitleW(f'Raid | Loaded token from config.json!')
time.sleep(2)
ctypes.windll.kernel32.SetConsoleTitleW(f'Raid | Prefix: {prefix} ')
# ----------------- start up----------------- #
print(f''' {Fore.RED}
     ██████╗  █████╗ ██╗██████╗ 
     ██╔══██╗██╔══██╗██║██╔══██╗
     ...
     ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═════╝ 
 \n
     skidded from alucard lol
     check README.md on git for cmds
''')
# ----------------- commands ----------------- #
@bot.command()
